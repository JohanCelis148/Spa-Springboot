...
public class ViewsRoles {
	...
	public Persons getRoleId() {
		return roleId;
	}

	public void setRoleId(Persons roleId) {
		this.roleId = roleId;
	}

	public Persons getViewId() {
		return viewId;
	}

	public void setViewId(Persons viewId) {
		this.viewId = viewId;
	}
