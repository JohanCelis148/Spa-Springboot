...
import com.spa.IService.IModulesService;
...
public class ModulesController {
	...
	@GetMapping("{id}")
	public Optional<Modules> show(@PathVariable Long id) {
	...
	@PutMapping("{id}")
	@ResponseStatus(code = HttpStatus.CREATED)
	 public Modules update(@PathVariable Long id, @RequestBody Modules modules) {
