...
public class RolesController {
	...
	public Roles update(@PathVariable Integer id, @RequestBody Roles roles) {
		...
		if (!op.isEmpty()) {
			...
			rolesUpdate.setUserCreationId(roles.getUserCreationId());
			rolesUpdate.setUserModificationId(roles.getUserModificationId());
			rolesUpdate.setDateCreation(roles.getDateCreation());
			rolesUpdate.setDateModification(roles.getDateModification());
