...
import com.sena.sql.lService.IUsersService;
...
public class UsersController {
	...
	public Users save(@RequestBody Users usersRoles) {
	...
	public Users update(@PathVariable Integer id, @RequestBody Users users) {
		...
		if (!op.isEmpty()) {
			...
			usersUpdate.setStatus(users.getStatus());
			usersUpdate.setUserCreationId(users.getUserCreationId());
			usersUpdate.setUserModificationId(users.getUserModificationId());
			usersUpdate.setDateCreation(users.getDateCreation());
			usersUpdate.setDateModification(users.getDateModification());
