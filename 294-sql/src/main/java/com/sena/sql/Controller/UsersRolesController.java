...
public class UsersRolesController {
	...
	public UsersRoles update(@PathVariable Integer id, @RequestBody UsersRoles usersRoles) {
		...
		if (!op.isEmpty()) {
			...
			usersRolesUpdate.setStatus(usersRoles.getStatus());
			usersRolesUpdate.setUserCreationId(usersRoles.getUserCreationId());
			usersRolesUpdate.setUserModificationId(usersRoles.getUserModificationId());
			usersRolesUpdate.setDateCreation(usersRoles.getDateCreation());
			usersRolesUpdate.setDateModification(usersRoles.getDateModification());
			usersRolesUpdate.setUserId(usersRoles.getUserId());
			usersRolesUpdate.setRol(usersRoles.getRol());
